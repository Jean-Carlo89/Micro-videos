...
describe("CategoryFakerBuilder Unit Tests", () => {
  describe("category_id prop", () => {
    ...
    test("should throw error when any with methods has called", () => {
      expect(() => faker.category_id).toThrowError(new Error("Property category_id not have a factory, use 'with' methods"));
    });
  ...
  describe("created_at prop", () => {
    ...
    test("should throw error when any with methods has called", () => {
      ...
      expect(() => fakerCategory.created_at).toThrowError(new Error("Property created_at not have a factory, use 'with' methods"));
    });
  ...
  test("should create a category", () => {
    ...
    const category_id = new Uuid();
    category = faker.withUuid(category_id).withName("name test").withDescription("description test").deactivate().withCreatedAt(created_at).build();
  ...
  test("should create many categories", () => {
    ...
    const created_at = new Date();
    const category_id = new Uuid();
    categories = faker.withUuid(category_id).withName("name test").withDescription("description test").deactivate().withCreatedAt(created_at).build();
