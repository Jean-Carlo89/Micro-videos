...
describe("Category unit tests", () => {
  ...
  test("constructor of category- third method", () => {
    ...
    category = new Category({ name: "Movie", description: "some desc", is_active: false, created_at });
  ...
  it("should update", () => {
    let category = new Category({ name: "Movie", is_active: true, description: "first" });
  ...
  it("should activate a category", () => {
    let category = new Category({ name: "Movie", is_active: false, description: "first" });
